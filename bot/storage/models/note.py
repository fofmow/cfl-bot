...
class Note(ormar.Model):
    ...
    reminder_level: int = ormar.SmallInteger(default=NoteReminderLevel.LESS_19_MINUTES)
    creation_dt: datetime = ormar.DateTime(default=datetime.utcnow)
    creator: User = ormar.ForeignKey(User, related_name="notes")
    category: NoteCategory = ormar.ForeignKey(NoteCategory, related_name="notes")
